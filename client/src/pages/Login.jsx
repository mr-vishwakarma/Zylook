...
const Login = () => {
  ...
  const handleSocialLogin = (provider) => {
    toast.error(`${provider} login is not implemented yet. Please use email/password.`);
  };
    ...
    <div className="min-h-screen w-full bg-black flex flex-col md:flex-row p-3 md:p-4 gap-4 md:gap-12 items-stretch box-border select-none">
      ...
      <div className="hidden md:flex md:w-[45%] lg:w-[40%] bg-gradient-to-b from-purple-600 via-purple-900 to-[#0e071a] rounded-[2rem] p-10 flex-col justify-between relative overflow-hidden select-none">
        ...
        <div className="z-10 my-auto">
          <h2 className="text-3xl lg:text-4xl font-bold tracking-tight text-white mb-2 leading-tight">Welcome Back</h2>
          <p className="text-purple-200/70 text-sm leading-relaxed mb-8 max-w-xs">Access your curated stylist, complete outfit lookbooks, and fashion catalog.</p>
          ...
          <div className="flex flex-col gap-3.5 w-full">
            ...
            <div className="flex items-center gap-4.5 p-3.5 bg-white/5 border border-white/5 text-purple-200/60 rounded-2xl transition-all duration-300">
              ...
              <span className="text-sm font-semibold">Load wardrobe preferences</span>
            </div>
            ...
            <div className="flex items-center gap-4.5 p-3.5 bg-white/5 border border-white/5 text-purple-200/60 rounded-2xl transition-all duration-300">
              ...
              <span className="text-sm font-semibold">Explore personalized matches</span>
            </div>
          </div>
        </div>
